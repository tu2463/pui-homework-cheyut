...
function initTimer(t) {
    ...
    function animateNum (groupNum, timeNumber) {
        TweenMax.killTweensOf(groupNum.querySelector('.number-grp-wrp')); //??
    ...
    function updateTimerDisplay(timeNumbers) {
        console.log("updateTimerDisplay(",timeNumbers,")");
    ...
    function updateTimer() {
        ...
        if (timestr != '0000') setTimeout(updateTimer, 1000) // calls updateTimer after 1s 
